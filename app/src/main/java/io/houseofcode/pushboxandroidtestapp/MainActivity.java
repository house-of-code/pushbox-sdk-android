...
public class MainActivity extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		PushBoxSDK.setContextAndSenderIdAndKeys(this, "981909185717", "qkzc_1fqWpnjpe5q8zkt2Q", "CjhgZbAf4Gfc5o3CnKfi1g");
		PushBoxSDK.getInstance().logEvent("TEST");
		PushBoxSDK.getInstance().getInbox(new PushBoxSDK.PushboxInboxCallback()
		{
			@Override
			public void onSuccess(List<PushBoxMessage> messages)
			{
				Log.d("Test", "dette er result:" + messages.toString());
			}

			@Override
			public void onFailure(String reason)
			{
				Log.d("Test", "dette er fail: " + reason);
			}
		});
	}
